...
DR_OBSERVATIONS = [
    ...
    ("2026-03-30T00:00:00Z", "review_site", "third_party_observable", "fixture", "review_volume", "14",
     "14 reviews total across two review sites.", ORG_LEDGERLINE, "review_page", None),
    ...
    ("2026-06-08T00:00:00Z", "review_site", "third_party_observable", "fixture", "review_volume", "19",
     "19 reviews total. Implies well under 200 active users at observed review rates.", ORG_LEDGERLINE, "review_page", None),
...
EVIDENCE = [
    ...
    ("evd_mrr_1", "clm_dr_mrr", "corroborating", 1, 1, 0, "third_party_observable", 0.6, 0.0,
     "https://adnocap.github.io/counterproof-fixtures/ledgerline/pricing.html", 200, "Pricing $99 / $399 / custom.",
    ...
    ("evd_mrr_2", "clm_dr_mrr", "contradicting", 1, 1, 0, "third_party_observable", -2.8, 0.0,
     "https://adnocap.github.io/counterproof-fixtures/ledgerline/changelog.html", 200, "6 entries in 90 days, slowing to 3.",
    ...
    ("evd_mrr_3", "clm_dr_mrr", "contradicting", 1, 1, 0, "third_party_observable", -1.3, 0.0,
     "https://adnocap.github.io/counterproof-fixtures/ledgerline/reviews.html", 200, "19 reviews total across two sites.",
    ...
    ("evd_hc_1", "clm_dr_headcount", "contradicting", 1, 1, 0, "third_party_observable", -2.2, 0.0,
     "https://adnocap.github.io/counterproof-fixtures/ledgerline/team.html", 200, "Team page lists 3 named people with roles.",
    ...
    ("evd_fd_1", "clm_dr_founding", "contradicting", 1, 1, 0, "third_party_observable", -1.6, 0.0,
     "https://adnocap.github.io/counterproof-fixtures/ledgerline/index.html", 200, "First observable artifact: waitlist page, 2025-08-19.",
    ...
    ("evd_or_1", "clm_dr_mrr", "expected_absent", 0, 1, 0, None, 0.0, 3.4,
     "https://adnocap.github.io/counterproof-fixtures/ledgerline/careers.html", 404, None,
    ...
    ("evd_mo_reddit", "clm_mo_users", "corroborating", 1, 1, 0, "third_party_observable", 0.9, 0.0,
     "https://reddit.com/r/smallbusiness/", 200, "Weekly promo thread — 2026-06-28.",
    ...
    ("evd_mo_chlog", "clm_mo_changelog", "expected_absent", 0, 1, 1, None, -0.4, 3.2,
     "https://adnocap.github.io/counterproof-fixtures/northgate/changelog.html", 404, None,
...
# --- evidence for the nine VERIFIED claims -----------------------------
    ...
    ("evd_dom_dr_0", "clm_dr_domain_live", "corroborating", 1, 1, 0, "third_party_observable", 1.1, 0.0,
     "https://adnocap.github.io/counterproof-fixtures/ledgerline/checkout.html", 200, "Live Stripe checkout endpoint responds.",
    ...
    ("evd_dom_dr_1", "clm_dr_domain_live", "corroborating", 1, 1, 0, "third_party_observable", 1.1, 0.0,
     "https://adnocap.github.io/counterproof-fixtures/ledgerline/index.html", 200, "Not parked: real nav, dated content, no registrar placeholder.",
    ...
    ("evd_dom_mo_0", "clm_mo_domain", "corroborating", 1, 1, 0, "third_party_observable", 1.1, 0.0,
     "https://adnocap.github.io/counterproof-fixtures/northgate/checkout.html", 200, "Live Stripe checkout endpoint responds.",
    ...
    ("evd_dom_mo_1", "clm_mo_domain", "corroborating", 1, 1, 0, "third_party_observable", 1.1, 0.0,
     "https://adnocap.github.io/counterproof-fixtures/northgate/index.html", 200, "Not parked: dated content, working nav.",
    ...
    ("evd_ship_0", "clm_dr_shipped", "corroborating", 1, 1, 0, "third_party_observable", 1.1, 0.0,
     "https://adnocap.github.io/counterproof-fixtures/ledgerline/changelog.html", 200, "Dated changelog, 6 entries in 90 days.",
    ...
    ("evd_stripe_0", "clm_dr_stripe", "corroborating", 1, 1, 0, "third_party_observable", 1.1, 0.0,
     "https://adnocap.github.io/counterproof-fixtures/ledgerline/checkout.html", 200, "PSP endpoint returns a live session.",
    ...
    ("evd_price_1", "clm_dr_pricing", "corroborating", 1, 1, 0, "third_party_observable", 0.9, 0.0,
     "https://adnocap.github.io/counterproof-fixtures/ledgerline/pricing.html", 200, "Same three tiers present 60 days earlier.",
