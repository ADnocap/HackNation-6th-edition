...
CREATE TABLE IF NOT EXISTS observation (
    ...
    milestone_type      TEXT CHECK (milestone_type IN ('incorporated', 'shipped', 'first_revenue', 'first_hire')),
...
CREATE TABLE IF NOT EXISTS opportunity (
    ...
    opened_by               TEXT NOT NULL CHECK (opened_by IN ('apply', 'trigger', 'manual')),
...
CREATE TABLE IF NOT EXISTS stage_transition (
    ...
    entered_by          TEXT NOT NULL CHECK (entered_by IN ('system', 'trigger', 'apply', 'analyst')),
    exited_at           TEXT,
